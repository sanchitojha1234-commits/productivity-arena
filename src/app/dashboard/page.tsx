...
export default function Dashboard() {
  ...
  // SVG Chart Mock Data
  const weeklyData = [
    { day: "Mon", focus: 30, completed: 2 },
    { day: "Tue", focus: 45, completed: 3 },
    { day: "Wed", focus: 15, completed: 1 },
    { day: "Thu", focus: 60, completed: 4 },
    { day: "Fri", focus: 50, completed: 3 },
    { day: "Sat", focus: 90, completed: 6 },
    { day: "Sun", focus: focusTime, completed: tasks.filter(t => t.status === "Completed").length }
  ];
