      ...
      <footer className="border-t border-slate-950 bg-slate-950/50 py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold text-slate-400">
            <Link href="#" className="hover:text-slate-250 transition-colors">Privacy</Link>
            <Link href="#" className="hover:text-slate-250 transition-colors">Terms</Link>
            <Link href="#" className="hover:text-slate-250 transition-colors">Contact</Link>
          </div>
        </div>
      </footer>
    </div>
